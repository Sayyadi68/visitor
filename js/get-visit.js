...
function createTableWithBasketArray() {
    ...
    for (let i = 0; i < userBasket.length; i++) {
        ...
        tableBody.rows[i].cells[8].innerHTML = numberWithCommas(roundPrice(userBasket[i].discount));
        tableBody.rows[i].cells[9].innerHTML = numberWithCommas(roundPrice((userBasket[i].price * userBasket[i].count) - userBasket[i].discount));
        tableBody.rows[i].cells[10].innerHTML = numberWithCommas(roundPrice((userBasket[i].price * userBasket[i].count) + (0.09 * userBasket[i].price * userBasket[i].count)));
        tableBody.rows[i].cells[11].innerHTML = '<i onclick="removeProductFromBasket(this)" class="fa-solid fa-trash"></i>'
    }
}
